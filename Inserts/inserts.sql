...
EXEC sp_insertPropiedad 
  ...
  @imagenUrl = 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aGVybW9zYSUyMGNhc2F8ZW58MHx8MHx8fDA%3D&fm=jpg&q=60&w=3000', 
  @cantHabitaciones = 3, 
  @cantBannios = 2, 
  @areaM2 = 120.5, 
  @amueblado = 0;
...
EXEC sp_insertPropiedad 
  ...
  @idTipoInmueble = 2, 
  @identificacion = 504440503, 
  @imagenUrl = 'https://planner5d.com/blog/content/images/2021/12/photo-1582268611958-ebfd161ef9cf.jpeg', 
  @cantHabitaciones = 2, 
  @cantBannios = 1, 
  @areaM2 = 75.0, 
  @amueblado = 1;
...
EXEC sp_insertPropiedad 
  ...
  @imagenUrl = 'https://media.istockphoto.com/id/1067331430/es/foto/casa-moderna-con-piscina.jpg?s=612x612&w=0&k=20&c=XTrJzhKypZ9z67yRwrTc9knNh1bbRZHm_XFcYvXWPEg=', 
  @cantHabitaciones = 4, 
  @cantBannios = 3, 
  @areaM2 = 200.0, 
  @amueblado = 0;
...
EXEC sp_insertPropiedad 
  ...
  @imagenUrl = 'https://images.homify.com/v1487162659/p/photo/image/1835305/FACHADA_1.jpg', 
  @cantHabitaciones = 5, 
  @cantBannios = 4, 
  @areaM2 = 280.0, 
  @amueblado = 1;
...
EXEC sp_insertPropiedad 
  ...
  @imagenUrl = 'https://plus.unsplash.com/premium_photo-1661883982941-50af7720a6ff?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aGVybW9zYSUyMGNhc2F8ZW58MHx8MHx8fDA%3D&fm=jpg&q=60&w=3000', 
  @cantHabitaciones = 2, 
  @cantBannios = 1, 
  @areaM2 = 60.0, 
  @amueblado = 1;
...
EXEC sp_insertPropiedad 
  ...
  @imagenUrl = 'https://media.istockphoto.com/id/524085051/es/foto/la-hermosa-fachada-de-lujo-su-hogar-lejos-del-hogar-en-el-crep%C3%BAsculo.jpg?s=612x612&w=0&k=20&c=qk7Z3BGQ0T-A4xOFJHWIsfOu0DK8mFpKzsU0Klpi0j4=', 
  @cantHabitaciones = 1, 
  @cantBannios = 2, 
  @areaM2 = 150.0, 
  @amueblado = 0;
...
EXEC sp_insertPropiedad 
  ...
  @imagenUrl = 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEghEbaIF6cX133q9Ouz3vyZ8x7v8jctZgIciNaJk8jLHp-GBvXaalamTYqx0dTNvuROj6GWd9_kTsM54DezP05BM6nbImMJ6MP9WkZ55IfUgqcoX2IrHeNfx1-vlMlxftPbu9OAlO-cH50/s1600/fachada-casa-bonita-moderna1.jpeg', 
  @cantHabitaciones = 1, 
  @cantBannios = 1, 
  @areaM2 = 45.0, 
  @amueblado = 1;
