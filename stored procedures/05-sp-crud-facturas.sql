...
BEGIN
  ...
  BEGIN TRY
    ...
    IF @montoPagado IS NULL OR @montoPagado <= 0
      THROW 50010, 'El contrato no tiene un monto total v�lido.', 1;

    IF @porcentajeComision IS NULL OR @porcentajeComision < 0 OR @porcentajeComision > 100
      THROW 50011, 'El contrato no tiene un porcentaje de comisi�n v�lido.', 1;
    ...
    IF @nombreTipoContrato = 'Venta' 
      ...
      THROW 50017, 'No se pueden crear m�ltiples facturas para contratos de tipo Venta.', 1;

    -- Si es de alquiler, validar que no est� completamente pagado
    ...
    BEGIN
      ...
      IF @totalPagado >= @montoPagado
        THROW 50018, 'El contrato de alquiler ya ha sido pagado completamente. No se pueden emitir m�s facturas.', 1;
    END;

    -- Calcular IVA y comisi�n
    -- Calcular IVA y comisi�n
    ...
    -- Inserci�n autom�tica de clientes asociados
    ...
    SELECT 
        ...
        'Factura creada correctamente (clientes asociados autom�ticamente)' AS mensaje;
...
BEGIN
    ...
    SELECT 
        ...
        -- Solo mostrar al cliente con rol relevante seg�n el tipo de contrato
        ISNULL(
            (
                SELECT TOP 1
                    CONCAT(
